// +++++ BSPnoTempSensor.c (copy to "inc" folder and rename to BSP.c) +++++
...
//   time before returning a result. The temperature sensor takes about 1 second.
...
//   yet. The input function still block for the full duration
//   before returning. Since there is no actual sensor, the
